          ...
          <div className={display ? 'main-chat' : 'main-chat-close'}>
            <div className="main-chat-content">
              <div className="main-chat-group">
                ...
                {searchEmployee(conversationGroup, profile._id, search, 5).map((i, index) => (
                  <div onClick={() => this.makeGroupConversation(i)} className="main-chat-item" key={index}>
                    <span>{i.name}</span>
                    {/* <span className="sp-group-chat">20</span> */}
                    {this.state.countAll && this.state.countAll.map((i, idx) => i._id).indexOf(i._id) >= 0 ? (
              ...
              <div className="main-chat-group">
                ...
                {searchEmployee(employees, profile._id, search)
                  ...
                  .map((item , key) => (
                    <div className="main-chat-item" key={key}>
