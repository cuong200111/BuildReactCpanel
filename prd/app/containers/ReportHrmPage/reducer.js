...
import { DEFAULT_ACTION, MERGE_DATA, GET_API_SUCCESS, GET_INCREASES_OR_DECREASES, GET_INCREASES_OR_DECREASES_SUCCESS, GET_LATE, GET_LATE_SUCCESS, GET_HRM_BY_MONTH_SUCCESS, GET_HRM_BY_MONTH, GET_WAGE_BY_MONTH, GET_WAGE_BY_MONTH_SUCCESS, SORT_EMPLOY_DATE, SORT_EMPLOY_DATE_SUCCESS, SORT_EMPLOY_DATE_FAIL } from './constants';
...
function reportHrmPageReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case SORT_EMPLOY_DATE:
      return state.set('loadingChart', true);
    case SORT_EMPLOY_DATE_SUCCESS:
      return state.set('dataEmploy', action.data).set('loadingChart', false);
