...
import {
  ...
  SORT_EMPLOY_DATE_SUCCESS,
  SORT_EMPLOY_DATE_FAIL,
  SORT_EMPLOY_DATE,
} from './constants';
...
export function getIncreasesOrDecreases(idDepartmentFilter) {
  return {
    type: GET_INCREASES_OR_DECREASES,
    payload: idDepartmentFilter
  };
}
...
export function getHrmSagaDataemploy(data) {
  return {
    type: SORT_EMPLOY_DATE,
    data,
  };
}

export function getHrmSagaDataemploySuccess(data) {
  return {
    type: SORT_EMPLOY_DATE_SUCCESS,
    data,
  };
}
export function getHrmSagaDataemployFailure(data) {
  return {
    type: SORT_EMPLOY_DATE_FAIL,
    data,
  };
}
