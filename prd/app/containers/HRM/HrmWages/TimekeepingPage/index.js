        ...
        {selectedWages ? (
          <>
            {openDialog && (
              ...
              >
                <div style={{ width: !miniActive ? window.innerWidth - 260 : window.innerWidth - 80 }}>
                  <CustomAppBar title={'CẬP NHẬT BẢNG CHẤM CÔNG'} onGoBack={handleCloseWagesDialog} onSubmit={handleSave} disableAdd={true} />
                  <Grid container direction="row" style={{ padding: '15px 0px', marginTop: '45px' }}>
                    <Grid item xs={12}>
                      <Grid
                        container
                        direction="column"
                        ...
                        // alignItems="center"
                      >
                        <Typography style={{ marginTop: '14px' }} variant="h5">
                          BẢNG CHẤM CÔNG T{selectedWages.originItem.month || '...'}/{selectedWages.originItem.year || '...'}
                        </Typography>
                        {/* <Typography style={{marginLeft: '48px', marginTop: '-14px'}} >
                          {selectedWages &&
                  ...
                  />
                    ...
                    <Grid item xs={6} style={{ display: 'flex', marginTop: '-54px', marginLeft: '700px' }}>
                      <Grid item xs={6} style={{ marginRight: '10px' }}>
                        <CustomInputBase value={selectedWages['inChargedEmployeeId.name']} label="Nhân viên phụ trách"
                        inputProps={{
                          style: {
                            padding: '7px',
                          },
