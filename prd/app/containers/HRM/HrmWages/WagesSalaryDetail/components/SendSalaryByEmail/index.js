...
function ModalSalaryCalculationDetails(props) {
  const { open, onClose, onSendMail, rows, templates, listTitle, wageTable, formulaId , disableBtn} = props;
  ...
  return (
    <React.Fragment>
      <Dialog open={open} onClose={onClose}>
        ...
        <DialogActions>
          <Button onClick={handleSendMail} variant="outlined" color="primary" disabled ={disableBtn}>
            Gửi
          </Button>
