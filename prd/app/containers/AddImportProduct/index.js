     ...
     return (
       <div>
         <CustomAppBar
           ...
           title={
             addStock === 'add'
               ? `${intl.formatMessage(messages.chinhsua || { id: 'chinhsua', defaultMessage: 'Thêm mới đặt hàng' })}`
               : `${intl.formatMessage(messages.chinhsua || { id: 'chinhsua', defaultMessage: 'Cập nhật đặt hàng' })}`
           }
