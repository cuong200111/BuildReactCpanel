        ...
        {dataInfo ? data.map(item => {
          ...
          return (
            <GridMaterialUI item xs={6}>
              <TypographyDetail
                data={Array.isArray(dataInfo[item.name]) === true ? (dataInfo[item.name].length > 0 ? dataInfo[item.name].map(i => {
