...
console.log(result, 'resultresultresultresultresult result result')
  return result;
};
...
const move = (source, destination, droppableSource, droppableDestination) => {
  console.log(source, destination, droppableSource, droppableDestination, "source, destination, droppableSource, droppableDestination")
...
class DndUser extends Component {
  ...
  onDragEnd = result => {
    ...
    console.log(destination.droppableId, "destination.droppableId", destination.droppableId === 'droppable2')
            ...
            {(provided, snapshot) => (
              <div ref={provided.innerRef} style={getListStyle(snapshot.isDraggingOver)}>
                <div style={{ marginBottom: 12, display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <TextField value={this.state.searchText} onChange={this.handleOnChange} variant="outlined" label="Tìm kiếm" />
                </div>
