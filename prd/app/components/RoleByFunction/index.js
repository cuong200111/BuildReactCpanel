...
const dataDefault = [
  { code: 'Task', childCodes: ['TemplateTask', 'TaskConfig', 'ManagerTask'] },
  {
    code: 'CRM',
    childCodes: [
  ...
  },
  {
    ...
    childCodes: [
      ...
      'EducatePlan',
      'EducateRound',
      'hrmPersonnelManagement',
      'hrmAnnualLeaveManagement',
      'hrmClosingWork',
      'HrmRecruitmentUnit',
      'HrmWageSource',
      'HumanResource',
  ...
  { code: 'Stock', childCodes: ['Asset', 'Allocate', 'StockExport', 'StockImport', 'StockConfig', 'stockListProduct'] },
  ...
  { code: 'Calendar', childCodes: ['calendarMeeting', 'calendarWorking', 'MettingRoom', 'calendarConfig'] },
  {
    code: 'reports',
    childCodes: [
      ...
      'reportHrmAboutExpiredContract',
      'reportHrmWageByOrg',
      'ReportTotalCandidate',
      'ReportHrmCandidate',
      'reportHrmRecruitmentWave',
      'reportAnalystWage',
      'Accused',
      'reportCustomerUserProduct',
      'reportFinanceDebtOver',
      'reportSellEmployee',
      'reportStockExportByAsset',
      'reportStockExportByProduct',
      'reportStockGeneral',
      'reportStockGeneralAsset',
      'reportStockImportByAsset',
      'reportStockImportByProduct',
    ],
  },
  { code: 'Kpi', childCodes: [] },
  { code: 'setting', childCodes: ['LtAccount', 'DynamicForm', 'NewsFeed', 'Email', 'Field', 'SMS', 'Employee', 'TemplateType'] },
];
...
class RoleByFunction extends React.Component {
  ...
  render() {
    ...
    const addStock = this.props.addStock;
    ...
    return (
      <React.Fragment>
        <Table>
          ...
          <TableBody>
            {console.log(newAllFunctionForAdd, 'newAllFunctionForAdd')}
                    ...
                    <TableCell>
                      <div style={{ display: 'flex' }}>
                        <p
                          onClick={() => {
                            if (addStock) return;
                            this.detailRole(row.codeModleFunction);
                          }}
