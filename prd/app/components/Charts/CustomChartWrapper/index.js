...
function CustomChartWrapper(props) {
  ...
  const handleChangeDate = useCallback(
    (value, name) => {
      ...
      props.handleChangeDate(name, moment(value).format('YYYY-MM-DD'))
      setLocalQueryFilter({ ...localQueryFilter, [name]: value });
    },
  ...
  function onFilter(valueidDepartment) {
    props.onFilter && props.onFilter(valueidDepartment)
  }
  return (
    <div
      style={
                    ...
                    <DepartmentAndEmployee
                      ...
                      onChange={result => {
                        ...
                        if (result) {
                          ...
                          handleChangeDepartment && handleChangeDepartment(result)
